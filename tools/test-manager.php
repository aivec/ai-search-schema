...
wp_register_style( 'avc-ais-test-manager', false, array(), $plugin_version );
wp_add_inline_style( 'avc-ais-test-manager', $test_manager_css );
wp_enqueue_style( 'avc-ais-test-manager' );
