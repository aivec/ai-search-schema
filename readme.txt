...
= 0.10.2 =
* [Dev ビルド改善] **Test Manager リンク追加** (dev モード専用)
* [Dev ビルド改善] 設定ページ右下にフローティングボタンを表示
* [Dev ビルド改善] `tools/test-manager.php` への直接リンク
* [Dev ビルド改善] DEV バッジ付きで視認性を確保
* [Dev ビルド改善] `is_dev_mode()` メソッドで dev ビルドを検出
* [Dev ビルド改善] `test-spec.json` を v0.10.0 に更新
* [Dev ビルド改善] メニュー名を「AEO Schema」から「AI Search Schema」に変更
* [Dev ビルド改善] llms.txt 機能テストを追加 (UI-120〜123, FN-090〜093)
* [Dev ビルド改善] ライセンス機能テストを追加 (UI-130〜134, FN-100〜102)
* [Dev ビルド改善] テスト総数: 170件 (16件追加)
* [Dev ビルド改善] `readme.txt` の生成出力との同期を修正
* [Dev ビルド改善] PHPCS 警告を修正 (長い行、未使用パラメータ)
* [Dev ビルド改善] `composer.lock` を `composer.json` と同期
* [Dev ビルド改善] `class-ai-search-schema-settings.php`: `is_dev_mode()` メソッド追加
* [Dev ビルド改善] `templates/admin-settings.php`: Test Manager リンク UI 追加
* [Dev ビルド改善] WordPress 6.0以上
* [Dev ビルド改善] PHP 8.0以上
