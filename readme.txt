...
= 1.1.3 =
* [Compliance] Removed Pro license/trial UI and logic from the WP.org build
* [Compliance] Documented external services (Google Maps Geocoding API, OpenStreetMap Nominatim)
* [Compatibility] Removed load_plugin_textdomain() (WP.org handles translations)
* [Security] Renamed helper functions to use `avc_ais_` prefix
* [Packaging] Removed WP.org directory assets from the plugin package
* [Docs] Added short description and updated installation path to the new slug
* [Build] Updated bundle/zip naming to `aivec-ai-search-schema`
