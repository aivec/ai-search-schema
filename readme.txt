...
* [変更内容] `yahnis-elsts/plugin-update-checker` (Puc_v4_Factory)
* [変更内容] `aivec/cptm-client` (ライセンス検証クライアント)
* [変更内容] 独自アップデートサーバー連携
...
* [検証済み] 禁止参照が 0 件であることを確認:
* [検証済み] Puc_v4_Factory
* [検証済み] plugin-update-checker
* [検証済み] yahnis-elsts
* [検証済み] cptm-client
* [検証済み] mysqli_get_server_info
