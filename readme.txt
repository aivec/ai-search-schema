...
= 1.1.4 =
* [Compliance] Excluded /bundle from distribution ZIP (dev-only file)
* [Compliance] Documented ZipCloud API (postal code lookup) in External Services section
* [Security] Removed direct mysqli_get_server_info() call; use $wpdb->db_version() only
* [Security] Escaped SVG path output with wp_kses() in wizard templates
* [Security] Escaped llms.txt output with esc_html()
* [Compliance] Renamed JS global variables from aisSettings/aisWizardData to avcAisSettings/avcAisWizardData
