...
<div class="ais-wizard-step ais-wizard-step--basics">
	<div class="ais-wizard-step__header">
		<h1 class="ais-wizard-step__title">
			<?php esc_html_e( 'Basic Information', 'aivec-ai-search-schema' ); ?>
		</h1>
		<p class="ais-wizard-step__description">
			<?php esc_html_e( 'Tell us about your site. This information will be used for search engine optimization.', 'aivec-ai-search-schema' ); ?>
		</p>
	</div>
		...
		<div class="ais-wizard-form">
			...
			<div class="ais-wizard-form__field">
				<label for="ais-wizard-site-name" class="ais-wizard-form__label">
					<?php esc_html_e( 'Site Name', 'aivec-ai-search-schema' ); ?>
				...
				<p class="ais-wizard-form__hint">
					<?php esc_html_e( 'The name of your website as it should appear in search results.', 'aivec-ai-search-schema' ); ?>
				</p>
			</div>
			...
			<div class="ais-wizard-form__field">
				<label for="ais-wizard-site-desc" class="ais-wizard-form__label">
					<?php esc_html_e( 'Site Description', 'aivec-ai-search-schema' ); ?>
				</label>
				...
				<p class="ais-wizard-form__hint">
					<?php esc_html_e( 'A brief description of your website (optional).', 'aivec-ai-search-schema' ); ?>
				</p>
			</div>
			...
			<div class="ais-wizard-form__field">
				<label class="ais-wizard-form__label">
					<?php esc_html_e( 'Site Logo', 'aivec-ai-search-schema' ); ?>
				</label>
				<div class="ais-wizard-logo-upload">
					<div class="ais-wizard-logo-upload__preview" id="ais-wizard-logo-preview">
						<?php if ( $site_logo ) : ?>
							<img src="<?php echo esc_url( $site_logo ); ?>" alt="<?php esc_attr_e( 'Logo preview', 'aivec-ai-search-schema' ); ?>">
						<?php else : ?>
							<div class="ais-wizard-logo-upload__placeholder">
								...
								<span><?php esc_html_e( 'No logo selected', 'aivec-ai-search-schema' ); ?></span>
							</div>
						<?php endif; ?>
					</div>
				...
				<p class="ais-wizard-form__hint">
					<?php esc_html_e( 'Recommended size: 600x60 pixels. PNG or SVG format.', 'aivec-ai-search-schema' ); ?>
				</p>
			</div>
		</div>
	</div>
