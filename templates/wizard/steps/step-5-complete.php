...
<div class="ais-wizard-step ais-wizard-step--complete">
	<div class="ais-wizard-complete">
		...
		<h1 class="ais-wizard-complete__title">
			<?php esc_html_e( 'Setup Complete!', 'aivec-ai-search-schema' ); ?>
		</h1>

		<p class="ais-wizard-complete__description">
			<?php esc_html_e( 'Congratulations! Your site is now optimized for search engines. Here is a summary of your settings.', 'aivec-ai-search-schema' ); ?>
		</p>
		...
		<div class="ais-wizard-summary">
			<h3 class="ais-wizard-summary__title">
				...
				<?php esc_html_e( 'Settings Summary', 'aivec-ai-search-schema' ); ?>
			</h3>

			<div class="ais-wizard-summary__content">
				<!-- Site Info -->
				<div class="ais-wizard-summary__section">
					<h4 class="ais-wizard-summary__section-title"><?php esc_html_e( 'Site Information', 'aivec-ai-search-schema' ); ?></h4>
					<dl class="ais-wizard-summary__list">
						<div class="ais-wizard-summary__item">
							<dt><?php esc_html_e( 'Site Name', 'aivec-ai-search-schema' ); ?></dt>
							<dd><?php echo esc_html( $options['site_name'] ?? get_bloginfo( 'name' ) ); ?></dd>
						</div>
						<div class="ais-wizard-summary__item">
							<dt><?php esc_html_e( 'Site Type', 'aivec-ai-search-schema' ); ?></dt>
				...
				<?php if ( ( $options['entity_type'] ?? '' ) === 'LocalBusiness' ) : ?>
					...
					<!-- Business Info -->
					<div class="ais-wizard-summary__section">
						<h4 class="ais-wizard-summary__section-title"><?php esc_html_e( 'Business Information', 'aivec-ai-search-schema' ); ?></h4>
						<dl class="ais-wizard-summary__list">
							<div class="ais-wizard-summary__item">
								<dt><?php esc_html_e( 'Business Name', 'aivec-ai-search-schema' ); ?></dt>
								<dd><?php echo esc_html( $options['company_name'] ?? '-' ); ?></dd>
							</div>
							<div class="ais-wizard-summary__item">
								<dt><?php esc_html_e( 'Business Type', 'aivec-ai-search-schema' ); ?></dt>
							...
							if ( ! empty( $address_parts ) ) :
								?>
								<div class="ais-wizard-summary__item">
									<dt><?php esc_html_e( 'Address', 'aivec-ai-search-schema' ); ?></dt>
									<dd><?php echo esc_html( implode( ' ', $address_parts ) ); ?></dd>
								</div>
							<?php endif; ?>
							<?php if ( ! empty( $options['phone'] ) ) : ?>
								<div class="ais-wizard-summary__item">
									<dt><?php esc_html_e( 'Phone', 'aivec-ai-search-schema' ); ?></dt>
		...
		<div class="ais-wizard-schema-preview">
			<h3 class="ais-wizard-schema-preview__title">
				...
				<?php esc_html_e( 'Generated Schema', 'aivec-ai-search-schema' ); ?>
			</h3>
			<div class="ais-wizard-schema-preview__content">
				<button type="button" class="ais-wizard-btn ais-wizard-btn--outline ais-wizard-btn--small" id="ais-wizard-show-schema">
					<?php esc_html_e( 'View JSON-LD Schema', 'aivec-ai-search-schema' ); ?>
				</button>
		...
		<div class="ais-wizard-next-steps">
			<h3 class="ais-wizard-next-steps__title"><?php esc_html_e( 'Next Steps', 'aivec-ai-search-schema' ); ?></h3>
			<ul class="ais-wizard-next-steps__list">
				<li>
					<svg viewBox="0 0 24 24" width="20" height="20" fill="#22c55e">
						<path d="M9 16.17L4.83 12l-1.42 1.41L9 19 21 7l-1.41-1.41z"/>
					</svg>
					<?php esc_html_e( 'Schema markup is now active on your site', 'aivec-ai-search-schema' ); ?>
				</li>
				<li>
					...
					printf(
						...
						esc_html__( 'Test your schema with %s', 'aivec-ai-search-schema' ),
						'<a href="https://search.google.com/test/rich-results" target="_blank" rel="noopener noreferrer">' . esc_html__( 'Google Rich Results Test', 'aivec-ai-search-schema' ) . '</a>'
					);
					?>
				</li>
				<li>
					...
					<?php esc_html_e( 'Customize additional settings from the plugin settings page', 'aivec-ai-search-schema' ); ?>
				</li>
			</ul>
		</div>
		...
		<div class="ais-wizard-complete__actions">
			<a href="<?php echo esc_url( admin_url( 'options-general.php?page=aivec-ai-search-schema' ) ); ?>" class="ais-wizard-btn ais-wizard-btn--primary ais-wizard-btn--large">
				<svg viewBox="0 0 24 24" width="20" height="20" fill="currentColor">
					<path d="M19.14 12.94c.04-.31.06-.63.06-.94 0-.31-.02-.63-.06-.94l2.03-1.58c.18-.14.23-.41.12-.61l-1.92-3.32c-.12-.22-.37-.29-.59-.22l-2.39.96c-.5-.38-1.03-.7-1.62-.94l-.36-2.54c-.04-.24-.24-.41-.48-.41h-3.84c-.24 0-.43.17-.47.41l-.36 2.54c-.59.24-1.13.57-1.62.94l-2.39-.96c-.22-.08-.47 0-.59.22L2.74 8.87c-.12.21-.08.47.12.61l2.03 1.58c-.04.31-.06.63-.06.94s.02.63.06.94l-2.03 1.58c-.18.14-.23.41-.12.61l1.92 3.32c.12.22.37.29.59.22l2.39-.96c.5.38 1.03.7 1.62.94l.36 2.54c.05.24.24.41.48.41h3.84c.24 0 .44-.17.47-.41l.36-2.54c.59-.24 1.13-.56 1.62-.94l2.39.96c.22.08.47 0 .59-.22l1.92-3.32c.12-.22.07-.47-.12-.61l-2.01-1.58zM12 15.6c-1.98 0-3.6-1.62-3.6-3.6s1.62-3.6 3.6-3.6 3.6 1.62 3.6 3.6-1.62 3.6-3.6 3.6z"/>
				</svg>
				<?php esc_html_e( 'Go to Settings', 'aivec-ai-search-schema' ); ?>
			</a>
			<a href="<?php echo esc_url( home_url( '/' ) ); ?>" class="ais-wizard-btn ais-wizard-btn--secondary ais-wizard-btn--large" target="_blank">
				...
				<?php esc_html_e( 'View Site', 'aivec-ai-search-schema' ); ?>
			</a>
		</div>
	</div>
</div>
