...
?>
<div class="ais-wizard-step avc-wizard-step--location">
	...
	<div class="ais-wizard-step__content">
		<div class="ais-wizard-form">
			...
			<div class="ais-wizard-form__field">
				<label for="avc-wizard-business-type" class="ais-wizard-form__label">
			...
			<!-- Business Name -->
			<div class="ais-wizard-form__field">
				<label for="avc-wizard-business-name" class="ais-wizard-form__label">
			...
			<div class="ais-wizard-form__section">
				...
				<div class="ais-wizard-form__row">
					<div class="ais-wizard-form__field avc-wizard-form__field--half">
						<label for="avc-wizard-postal-code" class="ais-wizard-form__label">
					...
					<div class="ais-wizard-form__field avc-wizard-form__field--half">
						<label for="avc-wizard-country" class="ais-wizard-form__label">
				...
				<div class="ais-wizard-form__field">
					<label for="avc-wizard-region" class="ais-wizard-form__label">
				...
				<div class="ais-wizard-form__field">
					<label for="avc-wizard-locality" class="ais-wizard-form__label">
				...
				<div class="ais-wizard-form__field">
					<label for="avc-wizard-street" class="ais-wizard-form__label">
				...
				<div class="ais-wizard-geocoding">
					<div class="ais-wizard-form__row">
						<div class="ais-wizard-form__field avc-wizard-form__field--half">
							<label for="avc-wizard-lat" class="ais-wizard-form__label">
						...
						<div class="ais-wizard-form__field avc-wizard-form__field--half">
							<label for="avc-wizard-lng" class="ais-wizard-form__label">
					...
					<button type="button" class="ais-wizard-btn avc-wizard-btn--secondary avc-wizard-btn--small" id="ais-wizard-geocode-btn">
			...
			<div class="ais-wizard-form__section">
				...
				<div class="ais-wizard-form__row">
					<div class="ais-wizard-form__field avc-wizard-form__field--half">
						<label for="avc-wizard-phone" class="ais-wizard-form__label">
					...
					<div class="ais-wizard-form__field avc-wizard-form__field--half">
						<label for="avc-wizard-email" class="ais-wizard-form__label">
			...
			<!-- Price Range -->
			<div class="ais-wizard-form__field">
				<label for="avc-wizard-price-range" class="ais-wizard-form__label">
	...
	<div class="ais-wizard-step__footer">
		<a href="<?php echo esc_url( add_query_arg( 'step', 'api-key' ) ); ?>" class="ais-wizard-btn avc-wizard-btn--text">
			<svg viewBox="0 0 24 24" width="20" height="20" fill="currentColor">
				<path d="M15.41 7.41L14 6l-6 6 6 6 1.41-1.41L10.83 12z"/>
			</svg>
			<?php esc_html_e( 'Back', 'ai-search-schema' ); ?>
		</a>
		<button type="button" class="ais-wizard-btn avc-wizard-btn--primary avc-wizard-next-btn" data-next="hours">
